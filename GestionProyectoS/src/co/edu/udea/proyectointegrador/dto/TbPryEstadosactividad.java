...
/**
 * TbPryEstadosactividad generated by hbm2java
 */
public class TbPryEstadosactividad  implements java.io.Serializable {
    ...
    public TbPryEstadosactividad() {
    }

	
    public TbPryEstadosactividad(String vrNombre, String vrAdtusuario, Date dtAdtfecha) {
    ...
    public void setNbIdn(Integer ndbIdn) {
        this.nbIdn = ndbIdn;
    }
