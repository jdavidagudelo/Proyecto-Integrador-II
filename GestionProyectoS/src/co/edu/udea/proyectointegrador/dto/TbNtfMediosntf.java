...
/**
 * TbNtfMediosntf generated by hbm2java
 */
public class TbNtfMediosntf  implements java.io.Serializable {
    ...
    public TbNtfMediosntf() {
    }

	
    public TbNtfMediosntf(String vrNombre, String vrAdtusuario, Date dtAdtfecha) {
