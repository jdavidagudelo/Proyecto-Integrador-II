...
/**
 * TbNtfTipontfs generated by hbm2java
 */
public class TbNtfTipontfs  implements java.io.Serializable {
    ...
    public TbNtfTipontfs() {
    }

	
    public TbNtfTipontfs(String vrNombre, String vrAdtusuario, Date dtAdtfecha) {
